...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        $product = Product::factory()->create([
            ...
            'price' => null,
            'advantages' => ['Preparación lista para usar', 'Bajo olor', 'Práctico', 'Cero desperdicio', 'Construcción en limpio', 'Rendimiento en obra', 'Excelente adherencia', 'Disminuye cargas muertas', 'No inflamable', 'No contaminante', 'Impermeable', 'Pega sobre amplia gama de materiales'],
            'datasheet' => ['Tipo' => 'Mortero a base de resina cremosa', 'Color' => 'Gris, Multicolor']
        ]);
        ...
        $product = Product::factory()->create([
            ...
            'price' => null,
            'advantages' => [' Impermeabilizante a base del reciclaje de llantas', 'No requiere mantenimiento', 'Mayor resistencia a la intemperie', 'Los rayos UV no afectan o deterioran su acabado.', 'No requiere calor para su instalación','Aplicación en frío'],
            'datasheet' => ['Tipo' => 'Impermeabilizante', 'Color' => 'Negro']
        ]);
        ...
        $product = Product::factory()->create([
            ...
            'price' => null,
            'advantages' => ['Menos densidad y peso', '4-7 Veces más aislamiento térmico', '2 Veces más aislamiento acustico', '90% Ahorro de agua', '30% Ahorro energético'],
            'datasheet' => ['Tipo' => 'Panel prefabricado', 'Color' => 'Gris', 'Ancho' => '50cm', 'Espesor' => '10cm', 'Altura' => 'Variable', 'Densidad' => '0.900 Ton/m3', 'Peso' => '90 Kg/m2'],
        ]);
        ...
        Product::factory()->create([
            ...
            'price' => null,
            'advantages' => ['Pintura blanca, tipo 1.', 'Base de vinilo', 'Lavable', 'No tiene Plomo', 'Adherente', 'Mayor calidad', 'Mayor cubrimiento', ' Más económica'],
            'datasheet' => ['Tipo' => 'Pintura blanca, tipo 1.', 'Base' => 'Vinilo']
        ]);
    }
}
